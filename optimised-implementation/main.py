...
from controllers import SubmissionController, EvaluationManager
                            ...
                            with ui.row().classes('items-center gap-4'):
                                ...
                                if row['score'] is not None:
                                    ...
                                    def submit_score(sid=row['id'], sinput=score_input):
                                        ...
                                        EvaluationManager().submit_score(
                                            sid,
                                            int(current_reviewer_id.value),
                                            int(sinput.value)
                                        )
...
import os as _os
ui.run(title='Peer Review System (Optimised)', port=int(_os.getenv('PORT', 8081)), host='0.0.0.0')
